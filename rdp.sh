...
cat <<'EOF'
  ...
  / _ \/ _ \/ _ \                                
 / , _/ // / ___/                                
/_/|_/____/_/_______________   __   __   _______ 
     /  _/ |/ / __/_  __/ _ | / /  / /  / __/ _ \
    _/ //    /\ \  / / / __ |/ /__/ /__/ _// , _/
...
printf "%b" "${Y}"; typewriter "DragonCloud Systems!"; printf "%b" "${N}"
divider
sleep 0.6
...
printf "%b" "${G}"; typewriter "🔥 Powered by DragonCloud"; printf "%b" "${N}"
divider

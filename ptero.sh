...
while true; do
    ...
    # Banner
    echo -e "${PURPLE}    ___  __                  __         __       __${NC}"
    echo -e "${PURPLE}   / _ \/ /____ _______  ___/ /__ _____/ /___ __/ /${NC}"
    echo -e "${PURPLE}  / ___/ __/ -_) __/ _ \/ _  / _ `/ __/ __/ // / / ${NC}"
    echo -e "${PURPLE} /_/   \__/\__/_/  \___/\_,_/\_,_/\__/\__/\_, /_/  ${NC}"
    ...
    echo -e "${CYAN} └───────────────────────────────────────────────────────┘${NC}"
    echo ""
    echo -ne "${BOLD}${WHITE}  root@dragoncloud:~# ${NC}"
    read choice
    ...
    case $choice in
        ...
        2) create_user ;;
        3) update_panel ;;
        4) bash <(curl -fsSL https://raw.githubusercontent.com/dragongamer432/pteropanel/refs/heads/main/ssl.sh) ;;
        5) uninstall_ptero ;;
        6) clear; exit ;;
